...
mysqli_query($koneksi,"insert into barang values('$id_perangkat','$nama_perangkat','$jenis_perangkat','$nomor_seri','$lokasi','$tanggal_pembelian','$status','$tanggal_pemeliharaan_terakhir')");
