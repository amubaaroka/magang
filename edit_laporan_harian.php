<?php
        include 'koneksi.php';
            ...
            $query = "SELECT * FROM laporan_harian WHERE id_laporan='$id_laporan'";
        ...
        <!--Sidebar-->
            ...
            <main class="bg-white-300 flex-1 p-3 overflow-hidden">
                <div class="flex flex-col">
                    <div class="p-8">
                    <h2 class="text-2xl font-bold mb-4">Form Edit Laporan Harian</h2>
                        <form method="post" action="update_laporan_harian.php">
                        ...
                        <div>
                            ...
                            <select name="status" id="status" class="mt-1 p-2 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-idnigo-500 focus:border-indigo-500 sm:text-sm">
                                ...
                                <?php
                                foreach($statusEnumList as $value){
