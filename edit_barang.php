                    ...
                    <h2 class="text-2xl font-bold mb-4">Form Edit Barang</h2>
                        <form method="post" action="update_barang.php">
                            ...
                            <div class="mb-4">
                                ...
                                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="lokasi" type="text" name="lokasi" value="<?php echo $lokasi; ?>">
                            </div>
                            <div class="mb-4">
