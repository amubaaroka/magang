...
<div class="mx-auto bg-2rey-200">
    ...
    <div class="min-h-screen flex flex-col">
        ...
        <div class="flex flex-1">
            ...
            <div class="p-2">
            <a class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 rounded text-xs" href="tambah_laporan_harian.php">+ Tambah Laporan</a>
                <div class="mt-2">
                    <table class="min-w-full bg-white border border-gray-300 text-xs">
                        ...
                        <tr>
                            ...
                            <th class="w-2/12 py-2 px-2 uppercase font-semibold border border-gray-300">tanggal_laporan</th>
                            ...
                            <th class="w-2/12 py-2 px-2 uppercase font-semibold border border-gray-300">status</th>
                            <th class="w-2/12 py-2 px-2 uppercase font-semibold border border-gray-300">masalah_dilaporkan</th>
                            <th class="w-1/12 py-2 px-2 uppercase font-semibold border border-gray-300">catatan</th>
                    ...
                    $data = mysqli_query($koneksi, "
                        SELECT lh.*, b.nama_perangkat, b.lokasi
                        FROM laporan_harian lh
                        JOIN barang b ON lh.id_perangkat = b.id_perangkat
                    ");
                    while ($d = mysqli_fetch_array($data)){
                    ?>
                        <tr>
                            <td class="py-2 px-2 border border-gray-300"><?php echo $no++; ?></td>
                            <td class="py-2 px-2 border border-gray-300"><?php echo $d['tanggal_laporan']; ?></td>
                            ...
                            <td class="py-2 px-2 border border-gray-300"><?php echo $d['masalah_dilaporkan']; ?></td>
                            <td class="py-2 px-2 border border-gray-300"><?php echo $d['catatan']; ?></td>
                            <td class="py-2 px-2 border border-gray-300">
                                <a href="edit_laporan_harian.php?id_laporan=<?php echo $d['id_laporan']; ?>" class="text-blue-500 hover:text-blue-700">Edit</a>
                                <a href="hapus_laporan_harian.php?id_laporan=<?php echo $d['id_laporan']; ?>" class="text-red-500 hover:text-red-700 ml-1">Hapus</a>
                            </td>
                        </tr>
                    <?php
                    }
