<?php
        include 'koneksi.php';
            ...
            $query = "SELECT * FROM laporan_bulanan WHERE id_laporan='$id_laporan'";
        ...
        <!--Sidebar-->
            ...
            <div class="flex-1 p-4">
                <div class="bg-white p-6 rounded-lg shadow-lg">
                    <h2 class="text-2xl font-bold mb-4">Form Edit Laporan Bulanan</h2>
                    <form method="post" action="update_laporan_bulanan.php" class="space-y-4">
