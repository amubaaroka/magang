...
$query = "SHOW COLUMNS FROM jadwal_maintenance LIKE 'status'";
        ...
        <!--Sidebar-->
            ...
            <div class="flex-1 p-4">
                <div class="bg-white p-6 rounded-lg shadow-lg">
                    <h2 class="text-2xl font-bold mb-4">Form Tambah Jadwal</h2>
                    <form method="post" action="tambah_aksi_jadwal.php" class="space-y-4">
                        <div>
                            <label for="name" class="block text-sm font medium text-gray-700">Judul Maintenance</label>
                            <input type="name" name="name" id="name" class="mt-1 p-2 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                        </div>
                        <div>
                            <label for="id_perangkat" class="block text-sm font medium text-gray-700">Nama Perangkat</label>    
